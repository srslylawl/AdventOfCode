...
grid = open("day21.txt").read().splitlines()
...
print("odd points ", odd_points)
print("even points ", even_points)
...
print("corners: ", corner_t + corner_r + corner_b + corner_l);
...
print("small: ", small_tr + small_tl + small_br + small_bl);
...
print("large: ", large_tr + large_tl + large_br + large_bl);
